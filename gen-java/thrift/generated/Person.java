...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-01-30")
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MARRIEE_FIELD_DESC = new org.apache.thrift.protocol.TField("marriee", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean marriee; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    USERNAME((short)1, "username"),
    AGE((short)2, "age"),
    MARRIEE((short)3, "marriee");
  ...
  private static final int __MARRIEE_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USERNAME,_Fields.AGE,_Fields.MARRIEE};
  ...
  static {
    ...
    tmpMap.put(_Fields.MARRIEE, new org.apache.thrift.meta_data.FieldMetaData("marriee", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public boolean isMarriee() {
    return this.marriee;
  }

  public Person setMarriee(boolean marriee) {
    this.marriee = marriee;
    setMarrieeIsSet(true);
    return this;
  }

  public void unsetMarriee() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MARRIEE_ISSET_ID);
  }

  /** Returns true if field marriee is set (has been assigned a value) and false otherwise */
  public boolean isSetMarriee() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MARRIEE_ISSET_ID);
  }

  public void setMarrieeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MARRIEE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case MARRIEE:
      if (value == null) {
        ...
        setMarriee((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_marriee = true && this.isSetMarriee();
    boolean that_present_marriee = true && that.isSetMarriee();
    if (this_present_marriee || that_present_marriee) {
      if (!(this_present_marriee && that_present_marriee))
        return false;
      if (this.marriee != that.marriee)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMarriee()) ? 131071 : 524287);
    if (isSetMarriee())
      hashCode = hashCode * 8191 + ((marriee) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMarriee()).compareTo(other.isSetMarriee());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMarriee()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.marriee, other.marriee);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // MARRIEE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.marriee = iprot.readBool();
              struct.setMarrieeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMarriee()) {
        oprot.writeFieldBegin(MARRIEE_FIELD_DESC);
        oprot.writeBool(struct.marriee);
        oprot.writeFieldEnd();
      }
