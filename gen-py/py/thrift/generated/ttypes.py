...
class Person(object):
    ...
    def __init__(self, username=None, age=None, marriee=None,):
        self.username = username
        self.age = age
        self.marriee = marriee
    ...
    def write(self, oprot):
        ...
        if self.age is not None:
            ...
            oprot.writeFieldEnd()
        if self.marriee is not None:
            oprot.writeFieldBegin('marriee', TType.BOOL, 3)
            oprot.writeBool(self.marriee)
            oprot.writeFieldEnd()
...
Person.thrift_spec = (
    ...
    (3, TType.BOOL, 'marriee', None, None, ),  # 3
)
